...
window_measures_3_C7 = []
window_measures_4_C7 = []
window_measures_5_C7 = []
list_values_C7 = []

window_measures_AUXBP = []
window_measures_BP = []
window_measures_2_BP = []
window_measures_3_BP = []
window_measures_4_BP = []
window_measures_5_BP = []
list_values_BP = []
...
for med_BP in window_measures_AUXBP:
    window_measures_BP.append(med_BP[0::99])
    window_measures_2_BP.append(med_BP[5::99])
    window_measures_3_BP.append(med_BP[10::99])
    window_measures_4_BP.append(med_BP[15::99])
    window_measures_5_BP.append(med_BP[20::99])

for it in window_measures_2_BP:
    window_measures_BP.append(it)
for it in window_measures_3_BP:
    window_measures_BP.append(it)
for it in window_measures_4_BP:
    window_measures_BP.append(it)
for it in window_measures_5_BP:
    window_measures_BP.append(it)
...
for med in window_measures_AUXC7:
    window_measures_C7.append(med[0::99])
    window_measures_2_C7.append(med[5::99])
    window_measures_3_C7.append(med[10::99])
    window_measures_4_C7.append(med[15::99])
    window_measures_5_C7.append(med[20::99])

for it in window_measures_2_C7:
    window_measures_C7.append(it)
for it in window_measures_3_C7:
    window_measures_C7.append(it)
for it in window_measures_4_C7:
    window_measures_C7.append(it)
for it in window_measures_5_C7:
    window_measures_C7.append(it)
...
output_C7_measures = open('output_C7_measures.csv', 'w+', newline ='')
with output_C7_measures:
    write = csv.writer(output_C7_measures)
...
for i in range(0, len(list_values_C7)):
    #write = csv.writer(output_values_C7)
    output_values_C7.writelines(list_values_C7[i]+'\n')

#### write csv outputs for benzene and precursors measures

output_BP_measures = open('output_BP_measures.csv', 'w+', newline ='')
with output_BP_measures:
    write = csv.writer(output_BP_measures)
...
for i in range(0, len(list_values_BP)):
    #write = csv.writer(output_values_BP)
    output_values_BP.writelines(list_values_BP[i]+'\n')
